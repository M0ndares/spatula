...
async function infoRecipe(recipe, ingredients) {
    const response = await ai.models.generateContent({
        model: 'gemini-3.1-flash-lite',
        contents: [
            `Tell me the process to cook a ${recipe} utilizing ${ingredients}. It is PROHIBITED to say anything more than that.`
        ]
    });
    return response.text;
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1frn0br._.js.map